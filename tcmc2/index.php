  ...
  <div class="inner">
    <div id="content" class="site-content">
      <div id="home-slider-1" class="royalSlider rsMinW">
        <div class="rsContent slide2"> <a class="rsImg" href="images/thumb/slider1.jpg"></a>
          <div class="bContainer">
            <div class="rsABlock rs_text rs_text_meta" data-move-effect="top">Join the TCMC Team</div>
            <div class="rsABlock rs_text_box" data-move-effect="bottom"> Become a Member </div>
            <div class="rsABlock rs_button" data-move-effect="bottom"> <a href="members.php" class="ui huge button coloured">Join Now</a> </div>
          </div>
        </div>
        <div class="rsContent slide2"> <a class="rsImg" href="images/thumb/slider2.jpg" ></a>
          <div class="bContainer">
            <div class="rsABlock rs_text rs_text_meta" data-move-effect="top">Never Miss An Event Again</div>
            <div class="rsABlock rs_text_box" data-move-effect="bottom"> Explore Upcoming Events </div>
            <div class="rsABlock rs_button" data-move-effect="bottom"> <a href="events.php" class="ui huge button coloured">View Events</a> </div>
          </div>
        </div>
        <div class="rsContent slide3"> <a class="rsImg" href="images/thumb/slider3.jpg"></a>
          <div class="bContainer">
            <div class="rsABlock rs_text rs_text_meta" data-move-effect="top">Join the Experience</div>
            <div class="rsABlock rs_text_box" data-move-effect="bottom"> Volunteer at Events </div>
            <div class="rsABlock rs_button" data-move-effect="bottom"> <a href="members.php" class="ui huge button coloured">Sign Up</a> </div>
          </div>
        </div>
      </div>
      <!-- END royalSlider -->
      ...
      <div class="content"> <a href="about.php" class="white">
        ...
        <section class="events">
          <ul class="events-list">
            <li>
              <div class="event-container"> <a href="about.php">
                <div class="artist-image"><img src="images/CivicFront300.jpg" width="244" height="170" alt="The Townsville Community Music Centre"></div>
                </a>
...
?>
                ...
                <div class="event-info">
                  ...
                  <div class="event-info-details"> <span class="event-time"><strong><?php echo "$date"; ?></strong></span> <span class="event-location"> at the <?php echo "$event1[location]"; ?></span> </div>
            ...
            <li>
              <div class="event-container">
                ...
                <div class="event-info">
                  ...
                  <div class="event-info-details"> <span class="event-time"><strong><?php echo "$date"; ?></strong></span> <span class="event-location"> at the <?php echo "$event2[location]"; ?></span> </div>
            ...
            <li>
              <div class="event-container">
                ...
                <div class="event-info">
                  ...
                  <div class="event-info-details"> <span class="event-time">
                    <?php  echo "$row[user]"; ?>
