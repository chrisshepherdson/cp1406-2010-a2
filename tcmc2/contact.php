...
<body>
  <header class="boxed_content">
    <!-- START Logo -->
    <a href="index.html" id="logo-link" rel="home">
...
<div class="inner"> 
  ...
  <div id="content" class="site-content">
    ...
    <div class="footer-wrapper ">
      ...
      <div class="content">
        <div class="footer-logo"><a href="index.html"><img src="images/logo.png" width=147px height=98px alt="logo"></a></div>
        <ul class="footer-navigation">
          <li><a href="index.html">Home</a></li>
          <li><a href="events.html">Events</a></li>
          <li><a href="bulletinboard.html">Bulletin Board</a></li>
          <li><a href="arists.html">Artists</a></li>
