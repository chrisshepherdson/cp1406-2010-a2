        ...
        <form id='addevent' name='addevent' method='post' action='php/addeventprocess.php' enctype='multipart/form-data'>
            ...
            <table style='width:1'>
                <tr>
                    ...
                    <td><input name='date' class='date' type='date' id='date' placeholder='Date' required> </td>
                </tr>
                <tr>
                    <td><label class='webpageLabel' for='time'>Time:</label></td>
                    <td><input name='time' class='time' type='time' id='time' placeholder='Time' required></td>
                </tr>
