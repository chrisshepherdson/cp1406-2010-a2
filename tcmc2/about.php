...
Also discovered in the old collection were some pieces relevant to North Queensland. Local musicians performed these at a musical social afternoon on Sunday April 21st in C2 at the Civic Theatre. The remaining sheet music, books and CDs were put on display and distributed free of charge to the local music community.
    ...
    <section class="about-history">
        ...
        <div class="content">
        <p>
        Mira Henderson, who had extensive experience in community music work in England, was the first staff member. (Her position was Acting Director because she was only in Townsville for a brief spell.) She instigated a series of classes starting in 1984 using the skills of people living in Townsville to enhance and encourage music learners of all ages.</p>
		</div>
		<div class="title">
		<li id="accordion_icon"></li>
		1985
        ...
        <div class="content">
        <p>	
		This year the first lunchtime concert was held at the PercTucker Gallery. The importance of providing performance opportunities for emerging musicians had become evident and from this time, for a number of years, one of the major activities of the Centre was the production and management of concerts.</p>
		</div>
		<div class="title">
		<li id="accordion_icon"></li>
		1999
        ...
        <div class="content">
        <p>	
		A spectacular variety concert was held at the Townsville Civic Theatre to celebrate twenty years of the Music Centre and as a tribute to May Lou.</p>
		</div>
		<div class="title">
		<li id="accordion_icon"></li>
		2005
        ...
        <div class="content">
        <p>	
		The Centre moved to offices in the Old Magistrate's Court.</p>
		</div>
		<div class="title">
		<li id="accordion_icon"></li>
		2012
        ...
        <div class="content">
        <p>	
		The Centre moved to its present office in the Townsville Civic Theatre building.</p>
		</div>
		</div>
